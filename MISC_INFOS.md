...
mkdir -p $QUADLET_STORAGE_PATH/{n8n,pihole,caddy,linkding,mcp-hub,cloudflared,mealie}/{data,etc,config,dnsmasq.d}

# n8n runs as UID 1000, maps to host UID 100999 in rootless podman
chown -R 100999:100999 $QUADLET_STORAGE_PATH/n8n/data

# Other services owned by podman user
chown -R $(id -u):$(id -g) $QUADLET_STORAGE_PATH/{pihole,caddy,linkding,mcp-hub,cloudflared,mealie}
```
